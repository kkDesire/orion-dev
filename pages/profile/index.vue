  ...
  <UContainer v-if="user">
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="lg:w-8/12">
            ...
            <UCard
              ...
              :ui="{
                body: { base: 'h-full flex flex-col justify-center items-center gap-6' },
              }"
            >
    ...
    <UModal v-model="whatIsTemplateModal">
      <UCard
        :ui="{
          divide: 'divide-none',
          body: { base: 'prose dark:prose-invert' },
          header: { base: 'flex flex-row items-center justify-between' },
          footer: { base: 'flex flex-row items-center justify-between' },
        }"
      >
        <template #header>
